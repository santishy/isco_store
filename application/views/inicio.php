...
<div class="container">
	<div class="row">
		...
		<div class="col-xs-12">
			<h1 style="color:#0066FF !important;font-size:38px;">OFERTAS</h1><hr>
			<div class="col-xs-12 div Ofertas">
				<?php foreach($articles->result() as $ar) { ?>
					<div class="col-md-3 col-xs-6" >
						<div class="col-sm-12 divArticles">
							<figure>
								<a href="<?=base_url()?>productos/detallesproducto/<?=$ar->id_articulo?>"><img src="http://www.pchmayoreo.com/media/catalog/product/<?=substr($ar->sku, 0,1)?>/<?=substr($ar->sku, 1,1)?>/<?=$ar->sku?>.jpg" alt="" data-sku="<?=$ar->sku?>"/></a>
							</figure>
							<p class="descripcion">
			...
			<div class="col-xs-12 div Ofertas">
				<?php foreach($destacados->result() as $des) { ?>
					<div class="col-md-3 col-xs-6" >
						<div class="col-sm-12 divArticles">
							<figure>
								<a href="<?=base_url()?>productos/detallesproducto/<?=$des->id_articulo?>"><img src="http://www.pchmayoreo.com/media/catalog/product/<?=substr($des->sku, 0,1)?>/<?=substr($des->sku, 1,1)?>/<?=$des->sku?>.jpg" alt="" data-sku="<?=$des->sku?>"  /></a>
							</figure>
							<p class="descripcion">
		...
		<div class="col-xs-12 divBanners">
			<div class="col-sm-6 bannerPub" style="height:150px;">
				<figure>
					<img src="<?=base_url()?>banner/s1.jpg" alt="">
				</figure>
			</div>
			...
			<div class="col-xs-12 div Ofertas">
				<?php foreach($recomendados->result() as $rec) { ?>
					<div class="col-md-3 col-xs-6" >
						<div class="col-sm-12 divArticles">
							<figure>
								<a href="<?=base_url()?>productos/detallesproducto/<?=$rec->id_articulo?>"><img src="http://www.pchmayoreo.com/media/catalog/product/<?=substr($rec->sku, 0,1)?>/<?=substr($rec->sku, 1,1)?>/<?=$rec->sku?>.jpg" alt="" data-sku="<?=$rec->sku?>" /></a>
							</figure>
							<p class="descripcion">
